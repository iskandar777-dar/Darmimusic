...
from Darmimusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Darmimusic.core.call import Yukki
from Darmimusic.utils import seconds_to_min, time_to_seconds
from Darmimusic.utils.channelplay import get_channeplayCB
from Darmimusic.utils.database import is_video_allowed
from Darmimusic.utils.decorators.language import languageCB
from Darmimusic.utils.decorators.play import PlayWrapper
from Darmimusic.utils.formatters import formats
from Darmimusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Darmimusic.utils.inline.playlist import botplaylist_markup
from Darmimusic.utils.logger import play_logs
from Darmimusic.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "Bot ini tidak dapat memutar kueri spotify. Tolong minta pemilik saya untuk mengaktifkan spotify."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "Harap aktifkan Obrolan Suara.. Bot tidak dapat mengalirkan url..",
                )
            except Exception as e:
                return await mystic.edit_text(
