        ...
        if config.SET_CMDS == str(True):
            try:
                await self.set_bot_commands(
                    [
                        BotCommand("ping", "Pastikan bot hidup atau mati"),
                        BotCommand("play", "Mulai memutar lagu yang diminta"),
                        BotCommand("skip", "Pindah ke trek berikutnya dalam antrean"),
                        ...
                        BotCommand("shuffle", "Acak acak daftar putar yang antri."),
