...
from Darmimusic import YouTube, app
from Darmimusic.core.call import Yukki
from Darmimusic.misc import SUDOERS, db
from Darmimusic.utils.database import (is_active_chat,
...
from Darmimusic.utils.formatters import seconds_to_min
from Darmimusic.utils.inline.play import (panel_markup_1,
                                          panel_markup_2,
                                          panel_markup_3,
                                          stream_markup,
                                          telegram_markup)
    ...
    if command == "Pause":
        ...
        if int(command) in [1, 3]:
            if (duration_played - duration_to_skip) <= 10:
                ...
                return await CallbackQuery.answer(
                    f"Bot tidak dapat mencari karena durasi total telah terlampaui.\n\nSaat ini diputar** {bet}** menit dari **{duration}** menit",
                    show_alert=True,
                )
